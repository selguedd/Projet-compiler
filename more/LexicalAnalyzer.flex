...
// If/Else keywords
"if"	        {Symbol symb= new Symbol(LexicalUnit.IF,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
...
// while keywords
"while"	        {Symbol symb= new Symbol(LexicalUnit.WHILE,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
"do"            {Symbol symb= new Symbol(LexicalUnit.DO,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
"endwhile"      {Symbol symb= new Symbol(LexicalUnit.ENDWHILE,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
// for keywords
"for"           {Symbol symb= new Symbol(LexicalUnit.FOR,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
"from"          {Symbol symb= new Symbol(LexicalUnit.FROM,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
"by"            {Symbol symb= new Symbol(LexicalUnit.BY,yyline, yycolumn,new String(yytext()));System.out.println(symb.toString());}
